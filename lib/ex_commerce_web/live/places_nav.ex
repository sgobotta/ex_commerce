defmodule ExCommerceWeb.PlacesNav do
  ...
  defp handle_expanded_params(_params, _url, socket) do
    ...
    {:cont,
     socket
     |> assign(:container_classes, get_container_classes(live_action))
     |> assign(:header_classes, get_header_classes(live_action))
     |> assign(:banner_classes, get_banner_classes(live_action))
     |> assign(
       :avatar_container_classes,
       get_avatar_container_classes(live_action)
     )
     |> assign(:avatar_size_classes, get_avatar_size_classes(live_action))
     |> assign(:avatar_classes, get_avatar_classes(live_action))
     |> assign(
       :content_container_classes,
       get_content_container_classes(live_action)
     )
     |> assign(:content_classes, get_content_classes(live_action))
     |> assign(
       :accordion_container_classes,
       get_accordion_container_classes(live_action)
     )
     |> assign(:accordion_classes, get_accordion_classes(live_action))}
  end

  def get_container_classes(:show), do: ""
  def get_container_classes(:show_catalogue), do: ""
  def get_container_classes(:show_item), do: ""
  def get_container_classes(_action), do: ""
  ...
  def get_header_classes(_action), do: ""
  ...
  def get_banner_classes(_action), do: ""
  ...
  def get_avatar_container_classes(_action), do: ""
  ...
  def get_avatar_size_classes(_action), do: ""
  ...
  def get_avatar_classes(_action), do: ""
  ...
  def get_content_container_classes(_action), do: ""
  ...
  def get_content_classes(_action), do: ""
  ...
  def get_accordion_container_classes(_action), do: ""
  ...
  def get_accordion_classes(_action), do: ""
end
